...
export const DEFAULT_MCP_SERVERS =
  "visa=https://server.smithery.ai/albert-dwqs/viatsy-mcp," +
  "stays=https://server.smithery.ai/google/hotels," +
  "flights|routes=https://server.smithery.ai/kiwi," +
  "flights=https://server.smithery.ai/mrabi/google-flights," +
  "budget|stays=https://server.smithery.ai/shokjak/travel-deals-mcp," +
  "cost_exchange=https://server.smithery.ai/stockvibes07/exchange-mcp," +
  ...
  "destination|budget=https://server.smithery.ai/onetrip/pulse," +
  "destination|places=https://server.smithery.ai/sorted-travel/destinations," +
